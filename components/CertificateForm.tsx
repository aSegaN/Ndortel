// ============================================
// FICHIER: components/CertificateForm.tsx
    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full ${icon ? 'pl-12' : 'px-4'} pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-600 outline-none font-semibold text-sm transition-all ${
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {(!isExtractingOcr && ocrStatus && ocrTarget === null) && (
              <span className={`text-xs font-bold ${
                ocrStatus.includes('✓') ? 'text-emerald-600' : 
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block w-full">
                <div className={`p-4 border-2 border-dashed rounded-xl text-center cursor-pointer transition-all ${
                  cniRecto ? 'border-emerald-300 bg-emerald-50' : 'border-slate-200 hover:border-emerald-300'
                }`}>
                  {cniRecto ? (
            ...
            <div>
              <label className="block w-full">
                <div className={`p-4 border-2 border-dashed rounded-xl text-center cursor-pointer transition-all ${
                  cniVerso ? 'border-emerald-300 bg-emerald-50' : 'border-slate-200 hover:border-emerald-300'
                }`}>
                  {cniVerso ? (
                    <div className="space-y-2">
                      <CheckCircle2 className="mx-auto text-emerald-600" size={24} />
  ...
  const renderDocumentsTab = () => (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
        ...
        <label className="block w-full">
          <div className={`p-8 border-2 border-dashed rounded-xl text-center cursor-pointer transition-all ${
        ...
        {formData.fraudAnalysis && (
          <div className="space-y-4">
            <div className={`p-4 rounded-xl ${
              formData.fraudAnalysis.riskLevel === 'LOW' ? 'bg-emerald-900/50' :
                ...
                {formData.fraudAnalysis.findings.map((finding, index) => (
                  <div 
                    ...
                    className={`p-3 rounded-lg text-sm ${
                      finding.severity === 'CRITICAL' ? 'bg-red-900/30 text-red-300' :
